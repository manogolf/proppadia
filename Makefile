...
help:
	...
	@echo "  make workflow-path-audit [report missing python paths/modules referenced by workflows]"
	@echo "  make workflow-path-audit-strict [fail when workflow path/module refs are missing]"
