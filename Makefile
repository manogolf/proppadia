...
MLB_PREDICT_PROP_TYPES ?= $(MLB_PROD11_PROP_TYPES)
...
MLB_PROD11_PROP_TYPES ?= $(MLB_PROD8_PROP_TYPES),hits_runs_rbis,$(MLB_UNDERSERVED_PROMOTED_PROP_TYPES)
...
help:
	...
	@echo "  make mlb-pipeline-check-prod11 [JSON pipeline bundle scoped to production-11 prop lanes]"
...
mlb-show-config:
	...
	@echo "MLB_PROD11_PROP_TYPES=$(MLB_PROD11_PROP_TYPES)"
...
mlb-pipeline-check-prod11:
	$(MAKE) mlb-pipeline-check-json MLB_BASE_URL="$(MLB_BASE_URL)" MLB_DATE="$(MLB_DATE)" MLB_PREDICT_SAMPLE="$(MLB_PREDICT_SAMPLE)" MLB_PREDICT_MIN_SUCCESS="$(MLB_PREDICT_MIN_SUCCESS)" MLB_PREDICT_PROP_TYPES="$(MLB_PROD11_PROP_TYPES)" MLB_QUALITY_WINDOW_MODE="games" MLB_QUALITY_GAMES_BACK="$(MLB_QUALITY_GAMES_BACK)" MLB_QUALITY_MIN_TOTAL="$(MLB_QUALITY_MIN_TOTAL)" MLB_QUALITY_MIN_ACCURACY="$(MLB_QUALITY_MIN_ACCURACY)" MLB_QUALITY_PROP_SOURCES="$(MLB_QUALITY_PROP_SOURCES)" MLB_PROP_COVERAGE_WINDOW_MODE="games" MLB_PROP_COVERAGE_GAMES_BACK="$(MLB_PROP_COVERAGE_GAMES_BACK)" MLB_PROP_COVERAGE_REQUIRED="$(MLB_PROD11_PROP_TYPES)" MLB_PROP_COVERAGE_MIN_GRADED="$(MLB_CORE_MIN_GRADED)" MLB_PROP_COVERAGE_GATE_METRIC="row_source" MLB_PROP_COVERAGE_TRAINING_SOURCES="$(MLB_CORE_TRAINING_SOURCES)"
