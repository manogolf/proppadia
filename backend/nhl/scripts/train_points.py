...
def main():
    ...
    ap.add_argument("--train-csv", required=True, help="Historical CSV with 'y_points' and feature columns.")
    ...
    if "y_points" not in df.columns:
        print("FATAL: training CSV must include 'y_points'.", file=sys.stderr)
        sys.exit(2)
