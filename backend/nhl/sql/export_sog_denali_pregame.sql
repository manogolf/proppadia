...
WITH base AS (
  SELECT
    ...
    b2b_flag,
    pp_role_share_final,
    role_pp_share AS role_pp_share_raw,
    pp_role_source,

    -- Pairings already written onto the base table
    d10_top_mate_overlap_share_avg,
    d10_top_mate_overlap_share_std,
    d10_top3_mates_overlap_share_avg,
    d10_top3_mates_overlap_share_std,
    d10_shiftcharts_games,
    d10_shiftcharts_coverage_rate,

    d20_top_mate_overlap_share_avg,
    d20_top_mate_overlap_share_std,
    d20_top3_mates_overlap_share_avg,
    d20_top3_mates_overlap_share_std,
...
SELECT
  ...
  b.rest_days,
  b.b2b_flag,
  b.pp_role_share_final AS role_pp_share,
  b.pp_role_source,
  b.role_pp_share_raw,
  ...
  -- season TOI / shifts (now real, not NULL)
