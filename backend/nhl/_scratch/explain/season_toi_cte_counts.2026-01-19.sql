...
-- === CTE COUNTS ===
SELECT 'slate_rows' AS cte, COUNT(*) FROM slate_rows
UNION ALL SELECT 'prior_games' AS cte, COUNT(*) FROM prior_games
UNION ALL SELECT 'hist_rows' AS cte, COUNT(*) FROM hist_rows
UNION ALL SELECT 'final_values' AS cte, COUNT(*) FROM final_values;
