#!/usr/bin/env python3
"""Show recent MLB prod12 phase-2 history snapshots and regressions."""
...
def main(argv: Sequence[str] | None = None) -> int:
    ap = argparse.ArgumentParser(description="Read recent MLB prod12 phase-2 history.")
        ...
        rows.append(
            {
                ...
                "manifest_ok": ((checks.get("release_manifest") or {}).get("ok")),
                "replay_ok": ((checks.get("replay_latency") or {}).get("ok")),
                "candidate_ok": ((checks.get("candidate_eval") or {}).get("ok")),
