...
class Prod12TriggerRequest(BaseModel):
    ...
    mlb_daily_gate_enabled: Optional[int] = None
...
def trigger_mlb_prod12_cycle(
    ...
    env_overrides = {
        ...
        "MLB_DAILY_GATE_ENABLED": body.mlb_daily_gate_enabled,
...
def mlb_prod12_artifact(
    ...
    elif kind == "odds_snapshot":
        filename = f"odds_mlb_playerprops_{artifact.get('mlb_date')}.json"
